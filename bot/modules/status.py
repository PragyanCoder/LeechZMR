...
async def stats(_, message, edit_mode=False):
    ...
    bot_stats = f"<b><i><u>Honey Bot Statistics</u></i></b>\n\n"\
    ...
    sys_stats = f"<b><i><u>Honey System Statistics</u></i></b>\n\n"\
...
async def send_repo_stats(_, query):
    ...
    async with xclient() as client:
        ...
        v_url = "https://api.github.com/repos/"
    ...
    repo_stats = f"<b><i><u>Honey Repository Info</u></i></b> \n\n" \
...
async def send_bot_limits(_, query):
    ...
    bot_limit = f"<b><i><u>Honey Bot Limitations</u></i></b>\n" \
